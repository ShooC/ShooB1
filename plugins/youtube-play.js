...
`
    ...
    return conn.sendButton(m.chat, `${htki} 𝒀𝒕 𝑷𝒍𝒂𝒚 ${htka}`, sewa, thumbnail, [["menu", usedPrefix + "menu"], ["profile", usedPrefix + "profile"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: url,
                mediaType: "VIDEO",
                title: 'Klik video di atas untuk melihat',
                body: bottime,
                previewType: 0,
                thumbnail: img1
            }
